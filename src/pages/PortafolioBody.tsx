                                ...
                                <ul className="mt-1 w-max">
                                    <div className="flex flex-wrap">
                                        <li className="mr-6 text-xs shrink-0 mt-4">
                                            <a className="block hover:text-slate-200" href={""} target="_blank" rel="noreferrer noopener" aria-label={"(opens in a new tab)"} title={"Last visited"}>
                                        ...
                                        <li className="mr-5 text-xs shrink-0 mt-4">
                                            <a className="block hover:text-slate-200" href={""} target="_blank" rel="noreferrer noopener" aria-label={"(opens in a new tab)"} title={"Spanish Language"}>
