        ...
        <>
            ...
            <div>
                <p className="mb-4 ">
                    ...
                    <span className="font-medium text-slate-200 hover:text-teal-300 focus-visible:text-teal-300"   rel="noreferrer noopener" aria-label="">raising requirements, designing and developing software,</span>
                    {' '}
                    <span className="font-medium text-slate-200 hover:text-teal-300 focus-visible:text-teal-300" aria-label="advertising agency">performing <br /> unit tests</span>
                     {' '}and, {' '}
                    <span className="font-medium text-slate-200 hover:text-teal-300 focus-visible:text-teal-300"aria-label="">resolving incidents</span>
                     {' '} always following{' '}
                    <span className="font-medium text-slate-200 hover:text-teal-300 focus-visible:text-teal-300" aria-label="digital product studio (opens in a new tab)">quality standards</span>
                    .
                </p>
